...
.. list-table::
	...
	* - **gobject**	
	  - giotto object
	* - **...** 
	  - **Arguments passed on to** `dimCellPlot2D() <dimCellPlot2D>`_
...
.. seealso::
	For 3D plots see: `dimCellPlot2D() <dimCellPlot2D>`_ and for other dimension reduction cell annotation visualizations see: `dimCellPlot2D() <dimCellPlot2D>`_.
