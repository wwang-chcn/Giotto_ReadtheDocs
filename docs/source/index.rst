...
**Fig.B** Heatmap showing the marker genes for the identified cell populations in **Fig.A**, 
**Fig.C** Visualization in both expression and physical space of two representative slices within the z-orientation (100 μm and 400 μm). **Fig.D**, 
**Fig.E** Overlay of gene expression in both expression and physical space for the selected slices in **Fig.C**, **Fig.F**.
