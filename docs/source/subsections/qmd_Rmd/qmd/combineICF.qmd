...
`specific_feats_1`     |     specific Featset combo (need to position match specific_genes_2)
`specific_feats_2`     |     specific Featset combo (need to position match specific_genes_1)
