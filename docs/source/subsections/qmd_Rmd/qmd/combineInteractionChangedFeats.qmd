...
`specific_feats_1`     |     specific Featureset combo (need to position match specific_feats_2)
`specific_feats_2`     |     specific Featureset combo (need to position match specific_feats_1)
