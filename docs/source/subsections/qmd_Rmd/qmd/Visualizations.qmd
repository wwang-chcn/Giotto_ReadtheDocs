...
This tutorial walks through the visualization capabilities of Giotto. The clustering and dimension reduction methods focused on within the previous tutorial, [dimension reduction](./dimension_reduction.html), will be revisited and utilized to create heatmaps, violin plots, and visualizations that are unique to Giotto: spatial maps and networks.

This tutorial uses a merFISH dataset of mouse hypothalamic preoptic regions from [Moffitt et al.](https://doi.org/10.1126/science.aau5324) A complete walkthrough of that dataset can be found [**here**](./merFISH_hypoth_220915.html). To download the data used to create the Giotto Object below, please ensure that [wget](https://www.gnu.org/software/wget/?) is installed locally.
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/0-spatPlot2D.png){ width=50% }
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/1-spat3D.png){ width=150% }
<br>

## Create and Visualize Clusters
First, run a PCA on the data. For the purposes of this tutorial, no highly variable genes will be identified or used in the reduction. The data will simply undergo a dimension reduction through PCA. Then, run a UMAP on the data for pre-clustering visualization. The UMAP may be plotted in 2D and 3D.
```{r, eval=FALSE}
# Run PCA
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/2-UMAP_2D.png){ width=50% }
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/3-UMAP_3D.png)
<br>
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/leiden_0.25.200_UMAP_3D.png)
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/4-spatPlot2D.png){ width=50% }
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/5-spatPlot2D.png){ width=50% }
<br>
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/6-showClusterHeatmap.png){ width=50% }
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/7-showClusterDendrogram.png){ width=50% }
<br>
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/8-violinPlot.png){ width=50% }
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/9-plotMetaDataHeatmap.png){ width=50% }
<br>
...
![](/images/images_pkgdown/getting_started_figs/visualizations/Original_Cell_Types_UMAP_3D.png)
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/manual_cluster_typing_UMAP_3D.png)
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/10-spatPlot2D.png){ width=50% }
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/11-spat3D.png)
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/12-spatPlot2D.png){ width=50% }
...
spatPlot3D(testobj,
           ...
           select_cell_groups = c('Microglia', 'Ependymal', 'Endothelial'), show_other_cells = F)
```
![](/images/images_pkgdown/getting_started_figs/visualizations/13-spat3D.png)
<br>
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/Delaunay_network_spatPlot.png)
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/spatial_network_spatPlot.png){ width=50% }
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/large_network_spatPlot.png){ width=50% }
...
```
![](/images/images_pkgdown/getting_started_figs/visualizations/distance_network_spatPlot.png){width=50%}
