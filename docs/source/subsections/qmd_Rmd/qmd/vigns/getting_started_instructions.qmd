--- 
title: getting_started_instructions 
format: rst 
date: 2022-10-12 
...
To download the data used to create the Giotto Object below, please ensure that [wget](https://www.gnu.org/software/wget/?) is installed locally. To create the Giotto Object, here we:
...
![](/images/images_pkgdown/getting_started_figs/getting_started_instructions/original_clusters_black.png){ width=50% }
