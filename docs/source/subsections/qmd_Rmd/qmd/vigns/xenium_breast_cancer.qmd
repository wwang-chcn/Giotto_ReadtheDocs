---
title: 10x Xenium Human Breast Cancer Pre-Release
format:
  rst
...
![](../../../../images/tutorials/xenium_breast_cancer/pre_analysis/large_preview.png){width="70%"}
...
## Loading Xenium data
### Manual Method
Giotto objects can be manually assembled feeding data and subobjects into a creation function. A convenience function for automatically loading the xenium data from the directory and generating a giotto object is also available. (See @sec-autoload)  
...
![](../../../../images/tutorials/xenium_breast_cancer/pre_analysis/gpoints_blnk.png){width="32%"}
![](../../../../images/tutorials/xenium_breast_cancer/pre_analysis/gpoints_ngcode.png){width="32%"}
![](../../../../images/tutorials/xenium_breast_cancer/pre_analysis/gpoints_ngprbe.png){width="32%"}
![](../../../../images/tutorials/xenium_breast_cancer/pre_analysis/gpoints_expr.png){width="100%"}
...
```
![](../../../../images/tutorials/xenium_breast_cancer/pre_analysis/gpolys_centroids.png){width="70%"}
...
### Load dataset - Convenience Function {#sec-autoload}
The dataset can also be loaded through a convenience function.  
Description:
<details>
<summary>createGiottoXeniumObject()</summary>

**Loading the subcellular data...**  
*Run on a server  |  Memory usage: `85.25GB`, Time taken: `268.984 sec elapsed`*
```{r, eval=F}
...
*Run on a server  |  Memory usage: `909MB`, Time taken: `27.961 sec elapsed`*
```{r, eval=F}
...
```
![](../../../../images/tutorials/xenium_breast_cancer/1_spatplot.png){width="70%"}
...
*Run on a server  |  Time taken: `240.675 sec elapsed`*
```{r, eval=F}
...
![](../../../../images/tutorials/xenium_breast_cancer/2_HVF.png){width="70%"}  
...
![](../../../../images/tutorials/xenium_breast_cancer/3a_screePlot.png){width="49%"}
![](../../../../images/tutorials/xenium_breast_cancer/3b_PCA.png){width="49%"}
...
plotUMAP(xenium_gobj,
         ...
         save_param = list(
           save_name = '4b_UMAP'))
```
![](../../../../images/tutorials/xenium_breast_cancer/4a_tSNE.png){width="49%"}
![](../../../../images/tutorials/xenium_breast_cancer/4b_UMAP.png){width="49%"}
...
```
![](../../../../images/tutorials/xenium_breast_cancer/5_umap_leiden.png){width="80%"}
...
spatPlot2D(gobject = xenium_gobj,
           ...
           save_param = list(
             ...
             base_height = 15))
```
![](../../../../images/tutorials/xenium_breast_cancer/6_spat_leiden.png){width="100%"}
...
spatInSituPlotPoints(xenium_gobj,
                     ...
                     save_para = list(
                       save_name = '7_polys'))
```
![](../../../../images/tutorials/xenium_breast_cancer/7_polys.png){width="100%"}
...
```
![](../../../../images/tutorials/xenium_breast_cancer/8_subset_in_situ.png){width="100%"}
