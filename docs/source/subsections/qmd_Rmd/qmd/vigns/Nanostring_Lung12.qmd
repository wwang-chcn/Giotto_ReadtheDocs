...
## CosMx Project loading function {#sec-loadfxn}
Convenience function for loading in the CosMx data.
It loads subcellular transcript information and polygons and generates a `giotto` object with `giottoPoints` objects for both 'rna' and 'neg_probe' nested in the gobject `feat_info` slot, and a `giottoPolygon` object for the 'cell' spatial unit in the `spatial_info` slot.   
This function performs the manual object creation steps described below. To skip those steps and preliminary data exploration, go to @sec-objdone.  
  
Additionally, a comparison of the count matrix produced through the convenience function 'subcellular' workflow and Nanostring's provided matrix can be found at @sec-matcompare.
```{r, eval=FALSE}
...
`tx_file.csv` contains information on both actual features (960 targeted gene probes in this dataset) and negative probes (20) that are targeted to alien sequences defined by the External RNA Controls Consortium (ERCC) that do not exist in human tissue.  
...
<details><summary>feat_IDs</summary>
```{r, eval=FALSE}
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/pre_analysis/preview_negprb.png){width=80%}


## FOV shifts
`fov_positions_file.csv` contains information on the x and y shifts needed in order to put the FOVs tiles together into a cohesive whole. This information is needed during the gobject join process.
```{r, eval=FALSE}
#  load field of vision (fov) positions
fov_offset_file = fread(paste0(data_path, 'Lung12_fov_positions_file.csv'))
```

<details><summary>fov_offset_file</summary>
```{r, eval=FALSE}
...
# Visualize Cells and Genes of Interest {#sec-objdone}
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/1_inSituFeats.png){ width=100% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/2_spatCentroids.png){ width=100% }
...
```
**RNA**  
![](../../../../images/tutorials/nanostring_CosMx_Lung12/3.1_totalexpr.png){ width=80% }

**Negative Probes**  
![](../../../../images/tutorials/nanostring_CosMx_Lung12/3.2_totalnegprbe.png){ width=80% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/4_inSituDens.png){ width=100% }
...
<details><summary>morphometa</summary>
```{r, eval=FALSE}
# $rna
...
<details><summary>featmeta</summary>
```{r, eval=FALSE}
# $rna
...
<details><summary>featoverlapmeta</summary>
```{r, eval=FALSE}
# $rna
...
## Comparison of Giotto aggregated and Nanostring provided matrices {#sec-matcompare}
<details>
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/mat_comparison/mat_comparison.png){ width=80% }
...
![](../../../../images/tutorials/nanostring_CosMx_Lung12/mat_comparison/values_diff.png){ width=60% }
...
Back to convenience function: @sec-loadfxn
...
This method will produce both normalized and scaled values that are be returned as the 'normalized' and 'scaled' expression matrices respectively. In this tutorial, the normalized values will be used for generating expression statistics and plotting expression values. The scaled values will be ignored. We will also generate normalized values for the negative probes for visualization purposes during which the library normalization step will be skipped.  
- **pearson residuals:** *A normalization that uses the method described in [Lause/Kobak et al. 2021](https://doi.org/10.1186/s13059-021-02451-7)*.  
This produces a set of values that are most similar in utility to a scaled matrix and offer improvements to both HVF detection and PCA generation. These values should not be used for statistics, plotting of expression values, or differential expression analysis.  
```{r, eval=FALSE}
...
<details><summary>feature metadata</summary>
```{r, eval=FALSE}
# └──Spatial unit "cell"
#    ├──Feature type "rna"
...
```
**RNA**  
![](../../../../images/tutorials/nanostring_CosMx_Lung12/5.1_rna_norm_total_hist.png){ width=80% }  
**Negative Probe**  
![](../../../../images/tutorials/nanostring_CosMx_Lung12/5.2_neg_norm_total_hist.png){ width=80% }  
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/5.3_color_centroids.png){ width=100% }  
...
**RNA**
![](../../../../images/tutorials/nanostring_CosMx_Lung12/5.4_rna_color_polys.png){ width=100% }  
**Negative Probe**
![](../../../../images/tutorials/nanostring_CosMx_Lung12/5.5_neg_color_polys.png){ width=100% }  
...
<details><summary>highly variable features</summary>
```{r, eval=FALSE}
...
![](../../../../images/tutorials/nanostring_CosMx_Lung12/6.1_pearson_HVF.png){ width=60% }
...
![](../../../../images/tutorials/nanostring_CosMx_Lung12/6.2_screeplot.png){ width=49% }
![](../../../../images/tutorials/nanostring_CosMx_Lung12/6.3_PCA.png){ width=49% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/6.4_UMAP.png){ width=70% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/6.5_UMAP_feats.png){ width=100% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/7.1_UMAP_leiden.png){ width=70% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/7.2_spatdim_leiden.png){ width=100% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/7.3_spatinsitu_leiden.png){ width=100% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/8.1_smallfov_points.png){ width=95% }
![](../../../../images/tutorials/nanostring_CosMx_Lung12/8.2_smallfov_poly.png){ width=47% }
![](../../../../images/tutorials/nanostring_CosMx_Lung12/8.3_smallfov_leiden.png){ width=51% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/9_binspect_genes.png){ width=100% }
...
```
<details><summary>First 5 markers of each cluster</summary>
```{r, eval=FALSE}
...
![](../../../../images/tutorials/nanostring_CosMx_Lung12/10.1_gini_violin.png){ width=80% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/10.2_heatmap.png){ width=70% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/10.3_gini_genes.png){ width=100% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/11_anno_umap.png){ width=70% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/12_spatdim_type.png){ width=100% }
...
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/13_insitu_type.png){ width=100% }
...
spatInSituPlotPoints(fov_join,
                     ...
                     save_param = list(base_height = 6,
                                       save_name = '14_ICF'))
```
![](../../../../images/tutorials/nanostring_CosMx_Lung12/14_ICF.png){ width=100% }
