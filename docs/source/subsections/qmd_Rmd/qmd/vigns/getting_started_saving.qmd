...
*Please see the [Configuration]() and [Giotto Object](./getting_started_gobject.html) vignettes before walking through this tutorial.*
...
![](/images/images_pkgdown/getting_started_figs/getting_started_saving/clusters_black.png)
...
spatPlot(my_gobject, 
         ...
         save_plot = TRUE)
```
![](/images/images_pkgdown/getting_started_figs/getting_started_saving/-SpatPlot2D.png)
...
spatPlot(my_gobject, 
         ...
         save_param = list(save_folder = results_directory, # Create subdirectory
                           ...
                           base_width = 9))
```
![](/images/images_pkgdown/getting_started_figs/getting_started_saving/my_name.png)
...
![](/images/images_pkgdown/getting_started_figs/getting_started_saving/only_save.png)
