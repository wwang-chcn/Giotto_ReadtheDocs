...
![](/images/images_pkgdown/SeqFish_mouse_cortex/0-spatPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/1-HVFplot.png){ width=50% }

```{r, eval=TRUE}
## select genes based on HVF and feature (gene) statistics, both found in feature metadata
feature_metadata = fDataDT(SS_seqfish)
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/2-screePlot.png){ width=50% }

```{r, eval=TRUE}
plotPCA(gobject = SS_seqfish)
```

![](/images/images_pkgdown/SeqFish_mouse_cortex/3-PCA.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/4-UMAP.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/5-tSNE.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/6-UMAP.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/10-UMAP.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/11-showClusterHeatmap.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/12-showClusterDendrogram.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/13-spatDimPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/14-spatDimPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/15-violinPlot.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/16-plotMetaDataHeatmap.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/17-violinPlot.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/18-spatDimPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/19-plotHeatmap.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/20-plotHeatmap.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/21-spatPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/22-spatPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/23-spatPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/24-spatPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/25-spatPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/26-spatGenePlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/27-heatmSpatialCorFeats.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/28-rankSpatialCorGroups.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/29-spatCellPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/30-spatPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/31-cellProximityBarplot.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/32-cellProximityHeatmap.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/33-cellProximityNetwork.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/12_d_network_cell_cell_enrichment_self.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/34-cellProximitySpatPlot2D.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/35-spatPlot2D.png){ width=50% }
...
feature_metadata = fDataDT(SS_seqfish)
plot(feature_metadata$nr_cells, feature_metadata$mean_expr)
plot(feature_metadata$nr_cells, feature_metadata$mean_expr_det)
quantile(feature_metadata$mean_expr_det)
high_expressed_genes = feature_metadata[mean_expr_det > 3.5]$feat_ID
## identify genes that are associated with proximity to other cell types
plan('multisession', workers = 6)
ICFscoresHighGenes =  findInteractionChangedFeats(gobject = SS_seqfish,
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/36-plotCellProximityGenes.png){ width=50% }

```{r, eval=TRUE}
## filter genes
ICFscoresFilt = filterICF(ICFscoresHighGenes)
## visualize subset of interaction changed genes (ICGs)
ICF_feats = c('Jakmip1', 'Golgb1', 'Dact2', 'Ddx27', 'Abl1', 'Zswim8')
ICF_feats_types = c('Lhx6 iNeuron', 'Lhx6 iNeuron', 'L4 eNeuron', 'L4 eNeuron', 'astrocytes', 'astrocytes')
names(ICF_feats) = ICF_feats_types
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/37-plotICF.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/38-plotCCcomDotplot.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/39-plotRankSpatvsExpr.png){ width=50% }
...
![](/images/images_pkgdown/SeqFish_mouse_cortex/40-plotRecovery.png){ width=50% }
