...
### Getters and Setters
Giotto stores information in different [slots](getting_started_gobject.html#giotto-object-structure), which can be accessed through these getters and setters functions. They can be found in the [accessors.R](https://github.com/drieslab/Giotto/blob/suite/R/accessors.R) file. 
