...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/0-filterDistributions.png){ width=50% }


```{r, eval=FALSE}
filterDistributions(merFISH_gobject, detection = 'cells')
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/1-filterDistributions.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/2-filterCombinations.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/3-spatPlot2D.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/4-spat3D.png)
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/5-screePlot.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/6-UMAP_3D.png)
...
plotUMAP_3D(gobject = merFISH_gobject, 
            ...
            show_center_label = F)
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/7-UMAP_3D.png)
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/8-spatPlot2D.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/9-violinPlot.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/10-plotMetaDataHeatmap.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/11-plotMetaDataHeatmap.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/12-plotMetaDataHeatmap.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/13-UMAP_3D.png)
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/14-spat3D.png)
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/15-spatPlot2D.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/16-spat3D.png)
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/17-spatPlot2D.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/18-spat3D.png)
```{r, eval=FALSE}
spatPlot2D(gobject = merFISH_gobject, point_size = 1.0, 
           cell_color = 'cell_types', cell_color_code = mycolorcode,
           select_cell_groups = 'Inhibitory', show_other_cells = F,
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/19-spatPlot2D.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/20-spat3D.png)
```{r, eval=FALSE}
spatPlot2D(gobject = merFISH_gobject, point_size = 1.0, 
           cell_color = 'cell_types', cell_color_code = mycolorcode,
           select_cell_groups = c('Astrocyte', 'OD Mature', 'OD Immature'), show_other_cells = F,
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/21-spatPlot2D.png){ width=50% }
...
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/22-spat3D.png)
```{r, eval=FALSE}
spatPlot2D(gobject = merFISH_gobject, point_size = 1.0, 
           cell_color = 'cell_types', cell_color_code = mycolorcode,
           select_cell_groups = c('Microglia', 'Ependymal', 'Endothelial'), show_other_cells = F,
           group_by = 'layer_ID', cow_n_col = 2, group_by_subset = c(seq(260, -290, -100)))
```
![](/images/images_pkgdown/MerFISH_hypoth/220915_results/23-spatPlot2D.png){ width=50% }
