--- 
title: mouse_visium_kidney_210830 
format: rst 
date: ymd 
--- 
--- 
...
![](/images/images_pkgdown/general_figs/mouse_kidney_highres.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/0-spatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/1-spatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/2-spatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/3-HVFplot.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/4-screePlot.png){ width=50% } 

```{r, eval=FALSE}
plotPCA(gobject = visium_kidney)
```

![](/images/images_pkgdown/mouse_visium_kidney/210830_results/5-PCA.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/6-UMAP.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/7-tSNE.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/8-UMAP.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/9-spatDimPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/10-spatDimPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/11-violinPlot.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/11-z1-violinplot_gini.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/12-plotMetaDataHeatmap.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/13-dimFeatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/14-violinPlot.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/15-plotMetaDataHeatmap.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/16-dimFeatPlot2D.png){ width=50% } 
...
TO DO: See the [mouse Visium brain dataset](./mouse_visium_brain_200325.html) for an example.
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/17-spatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/18-plotStatDelaunayNetwork.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/19-spatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/20-spatFeatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/21-spatFeatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/22-spatFeatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/22-z1-heatmap_correlated_genes.pdf){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/22-z2-rank_correlated_groups.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/23-spatCellPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/24-spatPlot2D.png){ width=50% } 
...
![](/images/images_pkgdown/mouse_visium_kidney/210830_results/25-spatPlot2D.png){ width=50% } 
