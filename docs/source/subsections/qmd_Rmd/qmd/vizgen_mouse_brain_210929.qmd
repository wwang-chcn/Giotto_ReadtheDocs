...
subsetFOVs = c(220,221,222,223,224,225,245,246,247,248,249,250,275,276,277,278,279,280,302,303,304,305,306,307,330,331,332,333,334,335,358,359,360,361,362,363)
```
...
![](/images/images_pkgdown/vizgen_mouse_brain//0-overview_spatplot.png){width="60%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//1-FOVs.png){width="49%"}
![](/images/images_pkgdown/vizgen_mouse_brain//1b-FOVs.png){width="49%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//2-dapi0_preview.png){width="65%"}
...
spatPlot2D(gobject = vizgen,
           ...
           show_image = TRUE)
```
![](/images/images_pkgdown/vizgen_mouse_brain//3-img_overlay.png){width="60%"}
...
spatPlot2D(gobject = zoom,
           ...
           show_image = TRUE)
```
![](/images/images_pkgdown/vizgen_mouse_brain//4-img_overlay_zoom.png){width="60%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//5-nr_feats.png){width="60%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//6-screePlot.png){width="50%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//7-PCA.png){width="50%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//8-UMAP.png){width="50%"}
...
<details>
<summary>Cell Metadata Preview</summary>
...
![](/images/images_pkgdown/vizgen_mouse_brain//9-UMAP.png){width="50%"}
...
```
![](/images/images_pkgdown/vizgen_mouse_brain//10-spatPlot2D.png){width="60%"}
...
<details>
<summary>Preview km_spatialgenes</summary>
```{r, echo=TRUE}
...
![](/images/images_pkgdown/vizgen_mouse_brain//11-spatFeatPlot2D.png){width="60%"}
<br>  

## Working with subcellular information
...
![](/images/images_pkgdown/vizgen_mouse_brain//13-poly.png){width="50%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//14-point.png){width="65%"}

### Creating a subcellular Giotto object {#sec-subcellular}
...
<details>
<summary>Alternatively to append subcellular data to existing giotto object...</summary>

<br>

The subcellular information can also be attached to giotto objects built with the pre-aggregated information.
<!-- Moving forward, it might be better practice to keep objects created using aggregated data separate from those generated from the subcellular information to avoid confusion. -->
```{r, eval=FALSE}
...
![](/images/images_pkgdown/vizgen_mouse_brain//12-spatPlot2D.png){width="65%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//12b-spatInSituPlotPoints.png){width="65%"}

<center>------------------------ **end dropdown** ------------------------</center>
...
![](/images/images_pkgdown/vizgen_mouse_brain//15-spatInSituPlotPoints.png){width="100%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//16-spatInSituPlotPoints.png){width="80%"}
...
![](/images/images_pkgdown/vizgen_mouse_brain//17-spatInSituPlotPoints.png){width="80%"}
<!-- Note that feature points will end sharply after a spatial subset, but the polygons and images are not cut off by default. -->
