...
### Printout usage
- **verbose**
    - Functions with printouts should generally have a `verbose` param that is set to `TRUE` by default, where `TRUE` displays the printouts and `FALSE` suppresses them.    
- **wrapping text**
