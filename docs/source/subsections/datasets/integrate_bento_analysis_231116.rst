...
.. container:: cell
   ...
   .. code:: r
      ...
      python_path = "/sc/arion/work/wangw32/conda-env/envs/giotto/bin/python"
      # python_path = NULL
...
.. container:: cell
   ...
   .. code:: r
      ...
      # 19:48:18 --- INFO: Creating cell and nucleus segmentation dataframes
      # 19:49:31 --- INFO: Batch information found in cell_shape, adding batch information to adata
...
.. container:: cell
   ...
   .. code:: r
      ...
      # 19:50:20 --- INFO: Knee found at rank 5
      # 19:50:20 --- INFO: Saved to Bento_colocalization_knee_pos.png
...
.. container:: cell
   ...
   .. code:: r
      ...
      # [1] Giotto_3.3.2             GiottoVisuals_0.0.0.9006 GiottoClass_0.0.0.9010  
      # [4] GiottoUtils_0.0.0.9004  
      #
      # loaded via a namespace (and not attached):
      #  [1] reticulate_1.34.0  tidyselect_1.2.0   terra_1.7-55       xfun_0.41         
      #  [5] sf_1.0-14          lattice_0.21-9     colorspace_2.1-0   vctrs_0.6.4       
      #  [9] generics_0.1.3     htmltools_0.5.7    yaml_2.3.7         utf8_1.2.4        
      # [13] rlang_1.1.2        e1071_1.7-13       R.oo_1.25.0        pillar_1.9.0      
      # [17] glue_1.6.2         withr_2.5.2        DBI_1.1.3          R.utils_2.12.2    
      ...
      # [37] scales_1.2.1       backports_1.4.1    classInt_0.4-10    checkmate_2.3.0   
      # [41] jsonlite_1.8.7     bit_4.0.5          ggplot2_3.4.4      png_0.1-8         
      # [45] digest_0.6.33      stringi_1.8.1      dplyr_1.1.3        grid_4.2.3        
      # [49] scattermore_1.2    cli_3.6.1          tools_4.2.3        magrittr_2.0.3    
      # [53] proxy_0.4-27       tibble_3.2.1       colorRamp2_0.1.0   pkgconfig_2.0.3   
      # [57] Matrix_1.6-1.1     data.table_1.14.8  rmarkdown_2.25     rstudioapi_0.15.0 
      # [61] R6_2.5.1           units_0.8-4        compiler_4.2.3    
...
.. container:: cell
   ...
   .. code:: r
      ...
      # yaml                6.0.1
      # -----
      # Python 3.10.2 | packaged by conda-forge | (main, Mar  8 2022, 16:08:39) [GCC 9.4.0]
      # Linux-3.10.0-1160.el7.x86_64-x86_64-with-glibc2.35
      # -----
      # Session information updated at 2023-11-16 19:50
