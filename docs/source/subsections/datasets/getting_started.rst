...
.. |image1| image:: ../inst/images/icons/getting_started/icons_configuration.png
   :width: 20.0%
   :target: ./configuration.html
.. |image2| image:: ../inst/images/icons/getting_started/icons_giotto.png
   :width: 20.0%
   :target: ./getting_started_gobject.html
.. |image3| image:: ../inst/images/icons/getting_started/icons_processing.png
   :width: 20.0%
   :target: ./data_processing.html
.. |image4| image:: ../inst/images/icons/getting_started/icons_clustering.png
   :width: 20.0%
   :target: ./Dimension_reduction.html
.. |image5| image:: ../inst/images/icons/getting_started/icons_images.png
   :width: 20.0%
   :target: ./getting_started_images.html
.. |image6| image:: ../inst/images/icons/getting_started/icons_visualizations.png
   :width: 20.0%
   :target: ./Visualizations.html
.. |image7| image:: ../inst/images/icons/getting_started/icons_saving.png
   :width: 20.0%
   :target: ./getting_started_saving.html
.. |image8| image:: ../inst/images/icons/analyses/icons_image_analysis.png
   :width: 30.0%
   :target: ./temp_construction.html
.. |image9| image:: ../inst/images/icons/analyses/icons_cell_type.png
   :width: 30.0%
   :target: ./temp_construction.html
.. |image10| image:: ../inst/images/icons/analyses/icons_deconvolution.png
   :width: 30.0%
   :target: ./analyses_deconvolution_Oct2021.html
.. |image11| image:: ../inst/images/icons/analyses/icons_distribution.png
   :width: 30.0%
   :target: ./temp_construction.html
.. |image12| image:: ../inst/images/icons/analyses/icons_interaction.png
   :width: 30.0%
   :target: ./temp_construction.html
.. |image13| image:: ../inst/images/icons/analyses/icons_patterns.png
   :width: 30.0%
   :target: ./temp_construction.html
.. |image14| image:: ../inst/images/icons/analyses/icons_subcellular.png
   :width: 30.0%
   :target: ./temp_construction.html
