...
.. link-button:: https://github.com/drieslab/Giotto/tree/suite/R/spatial_visuals.R#L1166
		:type: url
...
+-----------------------------------+-----------------------------------+
| ``cow_rel_h``                     | cowplot param: relative heights   |
|                                   | of rows (e.g. c(1,2))             |
+-----------------------------------+-----------------------------------+
...
Other reduced dimension visualizations: ``dimPlot3D()``, ``dimPlot()``,
