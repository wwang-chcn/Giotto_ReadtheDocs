...
|                               | â€œsdimxâ€ (spatial dimension x),       |
|                               | â€œsdimyâ€, â€œsdimzâ€ respectively to     |
...
|                               | neighbors to consider. If â€œautoâ€,    |
|                               | â€œupper wiskerâ€ value of the distance |
|                               | vector between neighbors is used;    |
|                               | see the boxplot graphics             |
|                               | documentation for more               |
|                               | details.(default = â€œautoâ€)           |
+-------------------------------+--------------------------------------+
