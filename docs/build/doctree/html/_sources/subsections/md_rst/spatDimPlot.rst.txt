...
`\ ``spatDimPlot2D`` <#spatdimplot2d>`_ and `\ ``spatDimPlot3D`` <#spatdimplot3d>`_ for 3D visualization.

 Other spatial and dimension reduction visualizations:
 `\ ``spatDimPlot2D`` <#spatdimplot2d>`_ ,
